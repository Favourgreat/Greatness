...
const WorkSpaceCard = ({ monthlyPrice, bgImage, title }) => {
  ...
  return (
    <div className="w-[300px] rounded-[20px] border-[#0739A6] border-[1px] pb-5">
      <div className="relative rounded-t-[20px] h-[150px] overflow-hidden">
        ...
        <div className="absolute left-2 bottom-2 flex gap-5 text-sm text-white">
          <p className="rounded-2xl p-1 bg-[#0739A6]">{pricePerDay}/day</p>
          <p className="rounded-2xl p-1 bg-[#0739A6]">{monthlyPrice}/month</p>
        </div>
      </div>
      <div className="mt-3 w-auto px-4">
        <h2 className="font-semibold mb-2">{title}</h2>
        {title === "Freelancer" ? (
          <p className="text-xs font-semibold w-1/3 p-2 rounded-xl text-white bg-[#0739A6] bg-opacity-90">
            One Person
          </p>
        ) : (
          <p className="text-xs font-semibold w-10/12 p-2 rounded-xl text-white bg-[#0739A6] bg-opacity-90">
      ...
      <div className="px-4 mt-3">
        <div className="flex mb-2 gap-3 text-xs items-center">
          <div className="bg-[#0739A6] p-2 rounded-[100%] h-6 w-6 flex items-center justify-center text-white">
            @
          </div>
          <p>Fully Furnished</p>
        </div>
