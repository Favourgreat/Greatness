...
function ContentBox({ title }) {
  return (
    <div className="w-[250px] p-5 border rounded-lg">
      <div className="w-9 h-9 rounded-lg bg-[#0739A6] bg-opacity-50 flex items-center justify-center">
        <svg
          width="23"
          height="23"
          viewBox="0 0 23 23"
      ...
      <p className="text-sm">
        Making a difference and leaving a positive legacy through purposeful contribution.
      </p> 
    </div>
  );
}
