...
const Navbar = () => {
  ...
  const linkStyle = "transition ease-in cursor-pointer hover:text-[#0739A6]";
  const mobileLinkStyle =
    "transition ease-in cursor-pointer hover:text-[#0739A6] text-black";
  const activeStyle = linkStyle + " text-[#0739A6]";
            ...
            >
              ...
              <defs>
                <clipPath id="clip0_799_3">
                  <rect width="164" height="45.2779" fill="#0739A6" />
                </clipPath>
              </defs>
            </svg>
          </Link>
          ...
          <ul className="flex justify-between lg:gap-20">
            ...
            <div className="relative group">
              ...
              <div className="absolute hidden group-hover:flex flex-col gap-5 bg-white p-4 left-0 w-[200px]">
                <a href="https://academy.sasomtech.com" target="_black">
            ...
            <ul className="flex flex-col p-4 justify-between text-lg font-semibold gap-5 lg:gap-20">
              ...
              <div className="relative group">
                ...
                <div className="absolute bg-primary font-normal text-lg bg-opacity-20 hidden group-hover:flex flex-col gap-5 p-4 left-16 -top-28 w-[200px]">
                  <a href="https://academy.sasomtech.com" target="_black">
                    <li className="hover:text-[#0739A6] transition ease-in hover:cursor-pointer">
                      Academy
                    </li>
                  </a>
                  <Link to="/co-working-space">
