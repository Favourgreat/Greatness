...
const WorkingSpace = () => {
  return (
    <div className="pt-28">
      ...
      <header className="bg-[#0739A6] w-full bg-opacity-60 flex lg:justify-between flex-col lg:flex-row items-center gap-10">
      ...
      {/* //last column */}
      <div className="px-5 md:px-20 mt-5 py-5 bg-[#0739A6] bg-opacity-80 flex flex-col items-center lg:items-start ">
        <p className="text-white mb-3">What we offer</p>
        ...
        <div className=" flex flex-col md:flex-row flex-1 flex-wrap items-center justify-between gap-10 ">
          <ContentCard
            ...
            title="Fast Internet"
            description="Sasom  off­ers co-working space services for free­lancers, entre­preneurs, and profes­sionals. "
          />
